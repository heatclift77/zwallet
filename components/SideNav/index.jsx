...
export default function SideNav({page}) {
    ...
    return (
        <div>
            ...
            bg="bg-white"
            >
                <div className={`d-flex mb-5 ps-4 ${page === "dashboard" ? "link-active" : "link-inactive"}`}>
                    <div className="me-3">
                    ...
                    <Link href="/dashboard"><a className={`m-0 align-self-center ${page === "dashboard" ? "color-active" : "color-inactive"}`} onClick={(e)=>{}}>Dashboard</a></Link>
                </div>
                <div className={`d-flex mb-5 ps-4 ${page === "transfer" ? "link-active" : "link-inactive"}`}>
                    ...
                    <Link href="/transfer"><a className={`m-0 align-self-center ${page === "transfer" ? "color-active" : "color-inactive"}`}>Transfer</a></Link>
                </div>
                <div className={`d-flex mb-5 ps-4 ${page === "topup" ? "link-active" : "link-inactive"}`}>
                    ...
                    <Link href="/topup"><a className={`m-0 align-self-center ${page === "topup" ? "color-active" : "color-inactive"}`}>Top Up</a></Link>
                </div>
                <div className={`d-flex mb-5 ps-4 ${page === "profil" ? "link-active" : "link-inactive"}`}>
                    ...
                    <Link href="/profil"><a className={`m-0 align-self-center ${page === "profil" ? "color-active" : "color-inactive"}`}>Profil</a></Link>
                </div>
            </CustomLayout>
        </div>
    )
