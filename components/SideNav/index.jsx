            ...
            >
                <div className="h-100">
                    ...
                    <div style={{position:"absolute", bottom:40}}>
                        <div className={`d-flex ps-4 h-100 link-inactive`}>
                            <span className={`align-self-end material-icons me-3 color-inactive`}>logout</span>
                            <a className={`m-0 align-self-center color-inactive`} onClick={logOut} >Log out</a>
                        </div>
                    </div>
                </div>
            </CustomLayout>
