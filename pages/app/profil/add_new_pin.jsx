...
export default function addNewPin() {
    ...
    const handleSubmit = () => {
        if (pin.pin1.length > 0 && pin.pin2.length > 0 && pin.pin3.length > 0 && pin.pin4.length > 0 && pin.pin5.length > 0 && pin.pin6.length > 0) {
            ...
            axios({
                method : "PUT",
                url : `${process.env.api}/v1/user/changePin`,
                data : {
    ...
    return (
        <CustomLayout bg="bg-white">
            <div className="px-4">
                ...
                <p className="mb-5" style={{ fontSize: "14px", maxWidth: "320px", lineHeight: "32px" }}>Enter your New 6 digits Zwallet PIN below to continue to the next steps.</p>
                <div className="row mb-5">
                    <div className="col-6 mx-auto">
                        ...
                        <p className="text-danger my-2" style={{fontSize:"14px"}}>{state.error}</p>
                        <div className="my-5">
                            <MainCustomBtn
